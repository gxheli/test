...
jQuery(document).ready(function() {
    ...
    //
    var specialForbid = $("[data-action=forbid]:eq(0)");
    if (specialForbid.length !== 0) {
        var tips = specialForbid.data("tip");
        var href = specialForbid.data("href") ? specialForbid.data("href") : "";
