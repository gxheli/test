var BusRouteRow = React.createClass({
    ...
    detectValueState:function(value){
        ...
        var classname = "";
        var tips = "";
        if(!(value)||this.isFullSpace(value)){
            ...
            return(
                <div className="form-group"  data-suborderid ={suborderid} data-componentid={componentid} data-segmentcode ={segmentcode} >
                    ...
                    <div className="col-md-10">
                        <textarea type="text" rows={5} className="form-control input-inline input-medium  "  defaultValue={this.state.postValue[segmentcode]} onPaste = {this.handlerChange} onChange={this.handlerChange} >
                        </textarea>
            ...
            return (
                <tbody>
                    <tr>
                        ...
                        <td>    
                            <textarea type="text" rows={5} className="form-control input-inline input-medium  "  defaultValue={valueNoW} onPaste = {this.handlerChange} onChange={this.handlerChange} >
                            </textarea>
