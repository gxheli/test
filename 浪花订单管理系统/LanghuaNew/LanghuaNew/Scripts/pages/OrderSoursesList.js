jQuery(document).ready(function () {
	...
	jQuery('table#orderList')
        .DataTable({
            ajax: {
                url: "/OrderSourses/GetOrderSourses",
                type: 'post',
            },
            ordering: false,
            searching: false,
            ...
            columns: [
                ...
                //操作
                {
                    ...
                    "createdCell": function (td, cellData, rowData, row, col) {
                        var str =
                        '<div class="row">' +
                            '<a href="/OrderSourses/Edit/' + cellData + '">修改</a>' +
                        '</div>';
                        jQuery(td).html(str);
                    }
                }
    ...
    $('#operations').on("click", "a", function () {
        ...
        $.ajax({
            url: "/OrderSourses/UpdateDisable",
            type: 'post',
    ...
    $('body').on('click', '#exportproducts', function (e) {
        ...
        var varURL = "/OrderSourses/ExportExcel?";
