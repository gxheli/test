   ...
   -----------------------------------------------------------------------
        README file for JavaScript Engine Switcher for .Net: V8 1.4.1
   ...
   5.4.4 with support of V8 version 4.7.80.25. For correct
   ...
   RELEASE NOTES
   =============
   Microsoft ClearScript.V8 was updated to version 5.4.4 (support of V8
   version 4.7.80.25).
